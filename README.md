...
> 🎯 sections mark topics I still need to learn — picked for relevance to **Django Backend + Security** roles.
...
- #### 🔀 [If vs Try](/Stuff/Python/IfVsTry.md)
- #### 📑 Models
...
- [ ] Django ORM query optimization (`select_related`, `prefetch_related`, `EXPLAIN`)
...
- [ ] Rate limiting & throttling in DRF
...
**🎯 To Learn**
- [ ] Indexing strategies (B-tree, GIN, GiST) & `EXPLAIN ANALYZE`
...
**🎯 To Learn**
- [ ] Message queues (RabbitMQ, Kafka) & event-driven design
- [ ] Microservices vs. monolith trade-offs
- [ ] Caching strategies (write-through, cache-aside, invalidation)
- [ ] Idempotency & retry-safe API design
...
- [ ] Linux hardening (SELinux/AppArmor, file permissions, user isolation)
...
- [ ] Centralized logging & tracing (ELK/EFK, OpenTelemetry)
- [ ] Secrets rotation & management at scale

---

### 🔒 Security

- #### 🌀 [CIA Triad](/Stuff/Security/CIA.md)
...
- #### 🧨 Threat Modeling
	...
	- PASTA
- #### 🛡️ Hardening
	- [SCA (Software Composition Analysis)](/Stuff/Hardening/SCA.md)
- Access Control
	- DAC
	- MAD
	- RBAC
